    ...
    >
      ...
      <div className="relative mx-auto flex w-full max-w-[1448px] flex-col items-center justify-center gap-[39px] px-[18px] pb-[120px] pt-[104px] md:flex-row md:px-[77px] md:py-[76px]">
        ...
        >
          ...
          >
            At CRUZALLOMA, we believe that sustainable agriculture is the root
            of community prosperity. Our programs are designed to empower local
            farmers, foster future leaders, and create lasting economic growth
            for families across Mindanao.
          </p>
          <div
          ...
          >
            <button
              type="button"
              className="border border-white px-[16px] py-[8px] text-[10px] font-semibold leading-[1.5] font-sans transition-colors duration-500 hover:bg-white/30 md:px-[24px] md:py-[12px] md:text-[16px] md:font-normal hover:cursor-pointer"
            ...
            <button
              type="button"
              className="flex items-center gap-[5.424px] text-[10px] font-semibold leading-[1.5] underline font-sans transition-opacity duration-300 hover:opacity-75 md:gap-[8px] md:text-[16px] md:font-normal md:no-underline hover:cursor-pointer"
              data-name="RightLink"
        ...
        >
          ...
          >
            ...
            >
              ...
              <p className="font-sans text-[14px] leading-[1.5] md:text-[20px] md:leading-[127.975%]">
                Providing access to modern techniques and new markets to ensure
                our local farmers earn a sustainable living wage.
              </p>
            </article>
            ...
            >
              ...
              <p className="font-sans text-[14px] leading-[1.5] md:text-[20px] md:leading-[127.975%]">
                Supplying our community and local businesses with high-quality,
                organic produce that is healthy and sustainably grown.
              </p>
            </article>
          </div>
          ...
          >
            ...
            >
              ...
              <p className="font-sans text-[14px] leading-[1.5] md:text-[20px] md:leading-[127.975%]">
                Inspiring the next generation through hands-on school tours and
                providing invaluable real-world university internships.
              </p>
            </article>
            ...
            >
              ...
              <p className="font-sans text-[14px] leading-[1.5] md:text-[20px] md:leading-[127.975%]">
                Building a powerful network with LGUs, NGOs, and academic
                institutions to drive regional growth and environmental
                stewardship.
              </p>
            </article>
          </div>
